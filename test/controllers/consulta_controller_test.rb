...
class ConsultaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create consultum" do
    assert_difference("Consultum.count") do
      post consulta_url, params: { consultum: { Medico_id: @consultum.Medico_id, Paciente_id: @consultum.Paciente_id, data: @consultum.data, horario: @consultum.horario } }
    end
  ...
  test "should update consultum" do
    patch consultum_url(@consultum), params: { consultum: { Medico_id: @consultum.Medico_id, Paciente_id: @consultum.Paciente_id, data: @consultum.data, horario: @consultum.horario } }
